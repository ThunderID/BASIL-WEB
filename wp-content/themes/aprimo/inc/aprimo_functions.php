...
function aprimo_social_links($class="") {
    ...
    <ul class="<?php echo esc_attr($class); ?>">
        ...
        <?php if(!empty($dribbble)) { ?>
            <li><a href="<?php echo esc_url($dribbble); ?>" class="tran3s"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
        <?php } ?>
        <?php if(!empty($youtube)) { ?>
            <li><a href="<?php echo esc_url($youtube); ?>" class="tran3s"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
        <?php } ?>
        <?php if(!empty($lnkedin)) { ?>
            <li><a href="<?php echo esc_url($lnkedin); ?>" class="tran3s"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
        <?php } ?>
