...
function aprimo_scripts() {
    ...
    wp_enqueue_style('camera', APRIMO_DIR_VEND . '/Camera-master/css/camera.css');
    ...
    if(function_exists('cs_get_option')) {
        ...
        wp_enqueue_script('aprimo-map-script', APRIMO_DIR_JS . '/map-script.js', array('aprimo-theme'), null, true);
    }
